...
$eventDateValue = $event->getEventDate()->format('Y-m-d H:i');
?>
<!DOCTYPE html>
<html lang="fr">
<head>
        ...
        <div class="form-card">
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" value="<?php echo htmlspecialchars($event->getTitle()); ?>" required>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" id="event_date" name="event_date" value="<?php echo htmlspecialchars($eventDateValue); ?>" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="location" name="location" value="<?php echo htmlspecialchars($event->getLocation()); ?>" required>
                </div>

                <div class="form-group">
                    <label for="image_url">URL de l'image (optionnel)</label>
                    <input type="url" id="image_url" name="image_url" value="<?php echo htmlspecialchars($event->getImageUrl() ?? ''); ?>" placeholder="https://...">
                </div>
